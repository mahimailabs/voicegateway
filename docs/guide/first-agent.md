...
- [Core concepts](/docs/guide/core-concepts): understand gateways,
  stacks, projects, and fallbacks.
- [Configuration reference](/docs/configuration/voicegw-yaml): full
  YAML reference.
- [Projects](/docs/configuration/projects): per-project budgets and
  tracking.
- [Providers](/docs/configuration/providers): details on every
  supported provider.
