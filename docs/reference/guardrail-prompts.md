---
title: Guardrail prompt reference
description: The curated guardrail prompt assets VoiceGateway ships, the runtime wrapper the composer renders active categories into, the per-category instructions, and the reserved report_guardrail_action tool schema.
---
